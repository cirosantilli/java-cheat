...
Maven by Example from Sonatype:
...
Run all `.java` classes under `src/test/java`. TODO: how does Surefire decide the JUnit version? Seems to work with both JUnit 3 and 4 without any configuration.
